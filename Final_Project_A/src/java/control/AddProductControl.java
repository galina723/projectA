...
public class AddProductControl extends HttpServlet {
     ...
     * @throws IOException if an I/O error occurs
     */
    @Override // Just use shopping-page LoginSuccess
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ProductInCart productCart = new ProductInCart(idProduct, nameProduct, pathIMG, price);
        UserCartManager.addProductTo_One_UserCart(userName, productCart);
