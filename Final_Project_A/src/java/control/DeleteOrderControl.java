 ...
 * @author ADMIN
 */
@WebServlet(name = "DeleteOrderControl", urlPatterns = {"/DeleteOrderControl"})
public class DeleteOrderControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        orderMna.DeleteOrder(numOrder);
        OrderDAO.saveOrderList(orderMna.orderList);
        OrderProductManager orderPMna = new OrderProductManager();
        orderPMna.removeOrderProduct(numOrder);
        OrderProductDAO.saveOrderListProductByChar(orderPMna.orderProduct);
        httpsession.setAttribute("orderList", orderMna.orderList);
