...
public class ProductDetailControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null) {
            ...
            httpSession.setAttribute("IDProduct", IDProduct);
            httpSession.setAttribute("nameProduct", nameProduct);
            httpSession.setAttribute("price", price);
            httpSession.setAttribute("pathIMG", pathIMG);
            response.sendRedirect("product-detail_LoginSuccess.jsp");
